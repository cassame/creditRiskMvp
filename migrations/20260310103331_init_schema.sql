...
INSERT INTO strategies (code, name) VALUES
    ('resident_first_time', 'Resident: First time'),
    ('resident_repeat', 'Resident: Repeat'),
    ('nonresident_first_time', 'Non-resident: First time'),
    ('nonresident_repeat', 'Non-resident: Repeat');
...
DROP TABLE IF EXISTS check_names;
